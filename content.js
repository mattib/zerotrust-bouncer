...
function injectFloatingWidget(initialSettings) {
    ...
    panel.innerHTML = `
        ...
        <div id="view-main">
            <div class="panel-header" style="flex-direction: column; align-items: center; text-align: center;">
                <div id="brand-home" style="margin-bottom: 4px; cursor: pointer;" title="Open spiimask.com">${logoSvg}</div>
        ...
        <div id="view-pii">
            ...
            <div class="sub-panel-body">
                ...
                <div class="toggle-row"><span class="toggle-label">Sensitive Dates (issue/expiry/medical…)</span><label class="switch"><input type="checkbox" id="tgl-pii_date" ${initialSettings.pii_date ? 'checked' : ''}><span class="slider"></span></label></div>
                ...
                <div class="toggle-row"><span class="toggle-label">Bitcoin Wallet</span><label class="switch"><input type="checkbox" id="tgl-pii_btc_wallet" ${initialSettings.pii_btc_wallet ? 'checked' : ''}><span class="slider"></span></label></div>
                ...
                <div class="toggle-row"><span class="toggle-label">Password</span><label class="switch"><input type="checkbox" id="tgl-pii_password" ${initialSettings.pii_password ? 'checked' : ''}><span class="slider"></span></label></div>
            </div>
        </div>
    ...
    panel.querySelector('#btn-share').addEventListener('click', () => {
        window.open('https://bouncer-website.spiimask.workers.dev/#viral-loop', '_blank');
    });

    var brandHome = panel.querySelector('#brand-home');
    if (brandHome) brandHome.addEventListener('click', () => {
        window.open('https://bouncer-website.spiimask.workers.dev/', '_blank');
    });
